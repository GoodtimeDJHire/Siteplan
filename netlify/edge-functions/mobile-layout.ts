...
export default async (_request: Request, context: Context) => {
  ...
  const scripts = `${html.includes('/v68.js') ? '' : '<script src="/v68.js?v=20260909-mobile1"></script>'}${html.includes('/v69.js') ? '' : '<script src="/v69.js?v=20260909-mobile2"></script>'}${html.includes('/v70.js') ? '' : '<script src="/v70.js?v=20260909-mobile3"></script>'}`;
