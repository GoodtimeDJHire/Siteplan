...
export default async (_request: Request, context: Context) => {
  ...
  const scripts = `${html.includes('src="/v60.js"') ? '' : '<script src="/v60.js"></script>'}${html.includes('src="/v61.js"') ? '' : '<script src="/v61.js"></script>'}${html.includes('src="/v62.js"') ? '' : '<script src="/v62.js"></script>'}`;
...
export const config: Config = {
  path: "/*",
  excludedPath: ["/v60.js", "/v61.js", "/v62.js", "/api/*"]
};
