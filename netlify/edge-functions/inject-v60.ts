...
export default async (_request: Request, context: Context) => {
  ...
  const scripts = `${html.includes('src="/v60.js"') ? '' : '<script src="/v60.js"></script>'}${html.includes('src="/v61.js"') ? '' : '<script src="/v61.js"></script>'}${html.includes('src="/v62.js"') ? '' : '<script src="/v62.js"></script>'}${html.includes('/v63.js') ? '' : '<script src="/v63.js?v=20260909-1319"></script>'}`;
